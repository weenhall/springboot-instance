...
@Slf4j
@SpringBootTest
public class DynamicProcessGenerateTest {
    ...
    public void testDynamicDeploy() throws IOException {
        ...
        Assertions.assertEquals(1,listOfTask.size());
        Assertions.assertEquals("First Task",listOfTask.get(0).getName());
        Assertions.assertEquals("zhangshan",listOfTask.get(0).getAssignee());
