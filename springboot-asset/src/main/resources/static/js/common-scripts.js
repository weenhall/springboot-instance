...
/*
    ...
    $(".add_types").hide();
    $(".add_types_btn").bind("click",function(){
        $(".add_types").fadeIn();
    });



    //    $(".add_line").click(function(){//添加一行
    //    $(".delbtn").hide();
    //    var obj = '<div class="control-group para_set"><label class="control-label"></label><div class="controls"><input type="text" placeholder="参数名" class="input-large span2" name="para[]" form="uploadForm" required/><input type="text" placeholder="参数值" name="para[]" class="input-large span6" form="uploadForm" required/><button class="btn btn-danger delbtn" onclick="delbtn(this)"><i class="icon-remove"></i></button></div></div>';
    //    $(".para_set:last").after(obj);
    //    $(".para_set:last").children().children("input").addClass("newinput");
    //    });
    //
    //$(".del_line").click(function(){//删除一行
    //    $(".delbtn").show();
    //});


	var height = window.innerHeight;
	proheight = height - 100;
	$("#main-content").height(proheight);
	
	$(".page-welcome").css("font-size","50px").css("line-height",proheight+'px').css("text-align","center");
	}();
